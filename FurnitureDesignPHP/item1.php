...
<body>
  ...
  <main>
    <div class="wrapper">
      ...
      <section class="item">
        <h1 class="section-title">プロダクトタイトル</h1>
        <div id="item">
          <div class="item-img">
            <img src="./img/item1.jpg" alt="item1">
          </div>
          <div class="item-cnt">
            <div class="item-cnt-text">テキストテキストテキストテキストテキストテキストテキストテキストテキスト テキストテキストテキストテキストテキストテキストテキストテキストテキスト テキストテキストテキストテキストテキストテキストテキストテキストテキスト</div>
            <div class="item-cnt-price">¥99,999 +tax</div>
            <dl class="item-cnt-info">
              <dt class="item-cnt-info-ttl">SIZE：</dt>
              <dd class="item-cnt-info-cnt">W999 × D999 × H999</dd>
              <dt class="item-cnt-info-ttl">COLOR：</dt>
              <dd class="item-cnt-info-cnt">テキスト</dd>
              <dt class="item-cnt-info-ttl">MATERIAL：</dt>
              <dd class="item-cnt-info-cnt">テキストテキストテキスト</dd>
            </dl>
      ...
      <div class="view-more">
        <a href="products1.html">Back To Products</a>
      </div>
    </div>
  </main>
  <!-- ここからは footer です -->
